...
return function (App $app) {
    ...
    $app->get('/gestion_etudiants/modifier/{id}', [EtudiantController::class, 'modifier'])->setName('modifier-offres');
    $app->post('/gestion_etudiants/modifier/{id}', [EtudiantController::class, 'modifier']);
    $app->post('/gestion_etudiants/supprimer/{id}', [EtudiantController::class, 'supprimer'])->setName('supprimer-offres');
};
